...
const { renderIndex, renderLogin, renderRegister, renderNewProduct, renderProductos, renderPerfil, loginSesion, createUser, getProductoId, addProducts, updateProduct, deleteProduct, getUsers, getUserId, updateUser, deleteUser, getProducts } = require("../controllers/productController");
